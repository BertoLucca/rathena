...
int hom_levelup(struct homun_data *hd) {
    ...
    if (hd->master && battle_config.homunculus_show_growth) {
        char output[256];
        sprintf(
            output, "Growth: hp:%d sp:%d str(%.2f) agi(%.2f) vit(%.2f) int(%.2f) dex(%.2f) luk(%.2f) ", growth_max_hp,
            growth_max_sp, growth_str / 10.0, growth_agi / 10.0, growth_vit / 10.0, growth_int / 10.0,
            growth_dex / 10.0, growth_luk / 10.0
        );
...
void hom_init_timers(struct homun_data *hd) {
    if (hd->hungry_timer == INVALID_TIMER) {
        int hunger_delay = (battle_config.homunculus_starving_rate > 0 &&
...
bool HomunculusDatabase::parseStatusNode(
    const std::string &nodeName, const std::string &subNodeName, const ryml::NodeRef &node, s_hom_stats &bonus
) {
    uint32 value;
...
uint64 HomunculusDatabase::parseBodyNode(const ryml::NodeRef &node) {
    ...
    if (this->nodeExists(node, "Status")) {
        ...
        if (hom->gmin.HP > hom->gmax.HP) {
            ...
            this->invalidWarning(
                node,
                "GrowthMinimum HP %d is greater than GrowthMaximum HP %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->gmin.SP > hom->gmax.SP) {
            ...
            this->invalidWarning(
                node,
                "GrowthMinimum SP %d is greater than GrowthMaximum SP %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->gmin.str > hom->gmax.str) {
            ...
            this->invalidWarning(
                node,
                "GrowthMinimum STR %d is greater than GrowthMaximum STR %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->gmin.agi > hom->gmax.agi) {
            ...
            this->invalidWarning(
                node,
                "GrowthMinimum AGI %d is greater than GrowthMaximum AGI %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->gmin.vit > hom->gmax.vit) {
            ...
            this->invalidWarning(
                node,
                "GrowthMinimum VIT %d is greater than GrowthMaximum VIT %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->gmin.int_ > hom->gmax.int_) {
            ...
            this->invalidWarning(
                node,
                "GrowthMinimum INT %d is greater than GrowthMaximum INT %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->gmin.dex > hom->gmax.dex) {
            ...
            this->invalidWarning(
                node,
                "GrowthMinimum DEX %d is greater than GrowthMaximum DEX %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->gmin.luk > hom->gmax.luk) {
            ...
            this->invalidWarning(
                node,
                "GrowthMinimum LUK %d is greater than GrowthMaximum LUK %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->emin.HP > hom->emax.HP) {
            ...
            this->invalidWarning(
                node,
                "EvolutionMinimum HP %d is greater than EvolutionMaximum HP %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->emin.SP > hom->emax.SP) {
            ...
            this->invalidWarning(
                node,
                "EvolutionMinimum SP %d is greater than EvolutionMaximum SP %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->emin.str > hom->emax.str) {
            ...
            this->invalidWarning(
                node,
                "EvolutionMinimum STR %d is greater than EvolutionMaximum STR %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->emin.agi > hom->emax.agi) {
            ...
            this->invalidWarning(
                node,
                "EvolutionMinimum AGI %d is greater than EvolutionMaximum AGI %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->emin.vit > hom->emax.vit) {
            ...
            this->invalidWarning(
                node,
                "EvolutionMinimum VIT %d is greater than EvolutionMaximum VIT %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->emin.int_ > hom->emax.int_) {
            ...
            this->invalidWarning(
                node,
                "EvolutionMinimum INT %d is greater than EvolutionMaximum INT %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->emin.dex > hom->emax.dex) {
            ...
            this->invalidWarning(
                node,
                "EvolutionMinimum DEX %d is greater than EvolutionMaximum DEX %d for homunculus %s, capping minimum to "
                "maximum.\n",
        ...
        if (hom->emin.luk > hom->emax.luk) {
            ...
            this->invalidWarning(
                node,
                "EvolutionMinimum LUK %d is greater than EvolutionMaximum LUK %d for homunculus %s, capping minimum to "
                "maximum.\n",
    ...
    if (this->nodeExists(node, "SkillTree")) {
        ...
        for (const ryml::NodeRef &skill : skillsNode) {
            ...
            if (this->nodeExists(skill, "Clear")) {
                ...
                if (!found)
                    this->invalidWarning(
                        skill["Clear"], "Failed to remove nonexistent skill %s from homunuculus %s.\n",
