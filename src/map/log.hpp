...
enum e_log_cash_type : uint8 { LOG_CASH_TYPE_CASH = 0x1, LOG_CASH_TYPE_KAFRA = 0x2 };
...
void log_chat(
    e_log_chat_type type, int type_id, int src_charid, int src_accid, const char *map, int x, int y,
