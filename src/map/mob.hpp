...
enum MobDamageLogFlag { MDLF_NORMAL = 0, MDLF_HOMUN, MDLF_PET, MDLF_SELF };

enum e_size : uint8 { SZ_SMALL = 0, SZ_MEDIUM, SZ_BIG, SZ_ALL, SZ_MAX };
...
enum e_mob_bosstype : uint8 { BOSSTYPE_NONE, BOSSTYPE_MINIBOSS, BOSSTYPE_MVP };
...
int mob_getdroprate(
    struct block_list *src, std::shared_ptr<s_mob_db> mob, int base_rate, int drop_modifier, mob_data *md = nullptr
);
