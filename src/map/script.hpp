...
enum e_questinfo_markcolor : uint8 { QMARK_NONE = 0, QMARK_YELLOW, QMARK_GREEN, QMARK_PURPLE, QMARK_MAX };
...
bool set_reg_num(
    struct script_state *st, map_session_data *sd, int64 num, const char *name, const int64 value, struct reg_db *ref
);
bool set_reg_str(
