...
#define CREATE2(result, type, number, file, line, func)                                                                \
    (result) = (type *)aCalloc2((number), sizeof(type), (file), (line), (func))
#define RECREATE2(result, type, number, file, line, func)                                                              \
    (result) = (type *)aRealloc2((result), sizeof(type) * (number), (file), (line), (func))
