...
// Taken from
// https://support.microsoft.com/de-de/help/118626/how-to-determine-whether-a-thread-is-running-in-user-context-of-local
bool IsCurrentUserLocalAdministrator(void) {
    ...
    */
    ...
    __try {
        ...
        */
        if (!OpenThreadToken(
                GetCurrentThread(), TOKEN_DUPLICATE | TOKEN_QUERY,
        ...
        */
        if (!AllocateAndInitializeSid(
                &SystemSidAuthority, 2, SECURITY_BUILTIN_DOMAIN_RID, DOMAIN_ALIAS_RID_ADMINS, 0, 0, 0, 0, 0, 0,
                &psidAdmin
            ))
            __leave;
        ...
        if (!AddAccessAllowedAce(
                pACL, ACL_REVISION2, dwAccessMask,
        ...
        */
        ...
        if (!AccessCheck(
                psdAdmin, hImpersonationToken, dwAccessDesired, &GenericMapping, &ps, &dwStructureSize, &dwStatus,
                &fReturn
            )) {
            fReturn = FALSE;
            __leave;
